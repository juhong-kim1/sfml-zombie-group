...
SceneGame3::SceneGame3() :Scene(SceneIds::Game2)
{
}
...
void SceneGame3::Draw(sf::RenderWindow& window)
{
...
void SceneGame3::SpawnZombies(int count)
{
	for (int i = 0; i < count; ++i)
	{
		...
		zombie->Reset();
		float x = Utils::RandomRange(-650.f, 650.f);
		float y = Utils::RandomRange(-650.f, 650.f);
		zombie->SetPosition(sf::Vector2f(x, y));
		zombieList.push_back(zombie);
	}
}

//void SceneGame3::SpawnItems(int counts)
//{
...
void SceneGame3::SpawnHealthPack()
{
